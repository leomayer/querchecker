...
public class GelectraExtractionModel extends AbstractExtractionModel {
    ...
    /** Upgraded from base (110M) to large (335M) for better extraction quality. */
    private static final String MODEL_NAME = "gelectra-large-germanquad";
    private static final Path MODEL_DIR = Paths.get("src/main/resources/models/gelectra-large-germanquad");
