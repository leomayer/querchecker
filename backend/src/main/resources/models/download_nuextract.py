#!/usr/bin/env python3
"""
Download tensorblock/NuExtract-tiny-v1.5-GGUF (Q5_K_M quantization).
Base model: numind/NuExtract-v1.5-tiny (Qwen2-0.5B fine-tuned for structured extraction).
...
REPO_ID = "tensorblock/NuExtract-tiny-v1.5-GGUF"
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "nuextract-1.5-tiny")
