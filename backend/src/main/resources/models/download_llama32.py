...
Source: bartowski/Llama-3.2-3B-Instruct-GGUF (community upload, no auth required).
Architecture: llama — fully supported by llama.cpp 4.x.
...
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "llama-3.2-3b")
