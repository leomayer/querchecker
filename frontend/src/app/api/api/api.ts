...
export * from './researchController.service';
import { ResearchControllerService } from './researchController.service';
...
export const APIS = [DlExtractionControllerService, DlSettingsControllerService, HealthControllerService, ListingDetailService, ListingsService, ProductLookupService, ResearchControllerService, SettingsPreferencesService, SseControllerService, UsageService, WillhabenMetaService, WillhabenSearchService];
