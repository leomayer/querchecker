...
export class DlExtractionControllerService extends BaseService {
  ...
  ): Observable<DlExtractionStatusResponse>;
  public getTerms(
    whItemId: number,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext; transferCache?: boolean },
  ): Observable<HttpResponse<DlExtractionStatusResponse>>;
  public getTerms(
    whItemId: number,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext; transferCache?: boolean },
  ): Observable<HttpEvent<DlExtractionStatusResponse>>;
  public getTerms(
    whItemId: number,
    observe: any = 'body',
    ...
    return this.httpClient.request<DlExtractionStatusResponse>(
      'get',
