...
export class ListingDetailService extends BaseService {
  ...
  /**
   * Details zu einem Inserat abrufen und Aufruf erfassen
   * @endpoint post /api/listings/{id}/detail
   * @param id
  ...
  public openDetail(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext; transferCache?: boolean },
  ): Observable<HttpResponse<WhDetailDto>>;
  public openDetail(
    id: number,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext; transferCache?: boolean },
  ): Observable<HttpEvent<WhDetailDto>>;
  public openDetail(
    id: number,
    observe: any = 'body',
  ...
  public updateInterest(
    ...
    if (requestBody === null || requestBody === undefined) {
      throw new Error(
        'Required parameter requestBody was null or undefined when calling updateInterest.',
      );
    }
  ...
  public updateNote(
    ...
    if (requestBody === null || requestBody === undefined) {
      throw new Error(
        'Required parameter requestBody was null or undefined when calling updateNote.',
      );
    }
  ...
  public updateRating(
    ...
    if (requestBody === null || requestBody === undefined) {
      throw new Error(
        'Required parameter requestBody was null or undefined when calling updateRating.',
      );
    }
